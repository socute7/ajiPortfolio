    ...
    <section className={`relative w-full h-screen mx-auto`}>
      <div className="flex">
        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hii there, I'm{" "}
              <p className="name text-[#915EFF]">Aji Darma Saputra</p>
            </h1>
            <h3>
              <span
                ref={textRef}
            ...
            <div className="absolute link1">
              <a href="https://github.com/socute7" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/ajidarmasaputra/"
                target="_blank"
              >
                <ImLinkedin />
              </a>
              <a
                href="https://www.instagram.com/ajidarma_saputra/"
                target="_blank"
              >
                <AiOutlineInstagram />
              </a>
        ...
        <div className="imgcontainer1 absolute violet-gradient">
          <img src={aji} alt="" className="object-contain" />
        </div>
      </div>
